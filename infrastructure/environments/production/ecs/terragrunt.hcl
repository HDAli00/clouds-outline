...
dependency "iam" {
  config_path  = "../iam"
  mock_outputs = { execution_role_arn = "arn:aws:iam::123:role/x", web_task_role_arn = "arn:aws:iam::123:role/x", worker_task_role_arn = "arn:aws:iam::123:role/x" }
}
dependency "ecr" {
  config_path  = "../ecr"
...
dependency "alb" {
  config_path  = "../alb"
  mock_outputs = { web_tg_arn = "arn:aws:elasticloadbalancing:us-east-1:123:targetgroup/x/y" }
}
...
inputs = {
  ...
  worker_min_capacity = local.account.locals.ecs_worker_min_capacity
  worker_max_capacity = local.account.locals.ecs_worker_max_capacity
